...
const PostScroller = (props) => {
    ...
    const fetchPosts = async () => {
        ...
        if (props.content === "posts") {
            ...
            if (props.searchExists) query.search = props.search;
            ...
            {props.searchExists && (
                <Box>
                    <Typography variant="h5" gutterBottom>
                        Showing results for "{props.search}"
                    </Typography>
